# Generated by Powerlevel10k configuration wizard on 2022-06-16 at 21:15 -03.
...
# Type `p10k installer` to generate another config.
#
# Config for Powerlevel10k with classic powerline prompt style. Type `p10k installer` to generate
...
() {
  ...
  # Defines character set used by powerlevel10k. It's best to let `p10k installer` set it for you.
...
# Tell `p10k installer` which file it should overwrite.
